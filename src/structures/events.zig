...
/// https://docs.discord.food/gateway/gateway-events#voice-server-update
...
/// https://docs.discord.food/gateway/gateway-events#voice-state-update
pub const VoiceStateUpdate = struct {
    guild_id: ?Snowflake = null,
    channel_id: ?Snowflake = null,
    self_mute: bool,
    self_deaf: bool,
    self_video: ?bool = null,
    preferred_region: ?[]const u8 = null,
    preferred_regions: ?[][]const u8 = null,
    flags: ?u64 = null,
};

/// https://docs.discord.food/gateway/gateway-events#voice-channel-effect-send-voice-channel-effect-send-event-fields
pub const VoiceChannelEffectSend = struct {
    ...
    animation_type: ?u8 = null,
    /// The ID of the emoji animation
    animation_id: ?u8 = null,
    /// The emoji sent, if applicable
    emoji: ?Partial(Emoji) = null,
    /// The ID of the soundboard sound
    sound_id: ?Snowflake = null,
    /// The volume of the soundboard sound, from 0 to 1
    sound_volume: ?f32 = null,
};

/// https://docs.discord.food/gateway/gateway-events#voice-channel-start-time-update
pub const VoiceChannelStartTimeUpdate = struct {
    /// The ID of the voice channel
    id: Snowflake,
    /// The ID of the guild
    guild_id: Snowflake,
    /// The unix timestamp (in seconds) of when the current voice session started, or null if it was ended
    voice_start_time: ?i64 = null,
};

/// https://docs.discord.food/gateway/gateway-events#voice-channel-status-update
...
pub const TemplateSerializedSourceGuild = std.json.Value;
