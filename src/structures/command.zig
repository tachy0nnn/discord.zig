...
// * TODO: remove InteractionContextType from shared.zig, since InteractionContextType is already in integration.zig
...
pub const LocaleMap = Record([]const u8);

/// https://discord.com/developers/docs/interactions/application-commands#application-command-object-application-command-structure
/// https://docs.discord.food/interactions/application-commands#application-command-object
pub const ApplicationCommand = struct {
    ...
    name_localizations: ?LocaleMap = null, //?Localization = null,
    ...
    description_localizations: ?LocaleMap = null, //?Localization = null,
    /// Parameters for the command, max of 25
    options: ?[]ApplicationCommandOption = null,
    /// Set of permissions represented as a bit set
    default_member_permissions: ?[]const u8 = null,
    /// The command's permissions for the user in the guild
    // permissions: ?ApplicationCommandIndexPermissions = null,
    ///
